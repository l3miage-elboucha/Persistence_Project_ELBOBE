...
public class Triangle implements SimpleShape, Visitable {
    ...
    public void draw(Graphics2D g2) {
        ...
        GradientPaint gradient = new GradientPaint(mX, mY, Color.GREEN, mX + 50.0f, mY, Color.WHITE);
        g2.setPaint(gradient);
        float[] xcoords = { mX + 25.0f, mX, mX + 50.0f };
        float[] ycoords = { mY, mY + 50.0f, mY + 50.0f };
        GeneralPath polygon = new GeneralPath(Path2D.WIND_EVEN_ODD, xcoords.length);
        polygon.moveTo(mX + 25.0f, mY);
